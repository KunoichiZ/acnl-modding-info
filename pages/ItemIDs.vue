<template>
  <section class="container">
    ...
    <div>
      ...
      <br>Click a category on the left to display its items in the table below. You can view what each item looks like on <a href="http://moridb.com/">http://moridb.com/</a></center>
...
export default {
  ...
  head () {
    return {
      title: this.title,
      meta: [
        { hid: 'og-description', name: 'og:description', content: 'Item IDs' },
