...
export default {
  data () {
    return {
      title: 'Cheat List - ACNL Modding Info'
    }
  },
  head () {
    return {
      title: this.title,
      meta: [
        { hid: 'og-description', name: 'og_description', content: 'Cheat List for the plugin' },
...
#save-file-cheats, #unlock-cheats, #shop-cheats {
  padding: 15px;
...
#movement-cheats, #environment-cheats, #misc-cheats {
  padding: 15px;
